...
echo_and_run cd "/home/duarte/Documents/simulation_turtlebot/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/duarte/Documents/simulation_turtlebot/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/home/duarte/Documents/simulation_turtlebot/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
